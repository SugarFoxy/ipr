...
import static perf.ipr.api.core.RestRequest.getResponse;
import static perf.ipr.api.user.template.UserTemplate.*;
import static perf.ipr.api.util.GeneratorJson.toJson;
...
public class UserServiceImpl implements UserService {
    ...
    private static void setId(){
        id = getResponse().as(UserDto.class).getId().toString();
    }
